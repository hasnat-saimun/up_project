                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header text-bg-danger p-2 py-1">
                                        <h6>ব্যবসায় নিবন্ধন রিপোর্ট দেখুন</h6>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 mt-5">
                                <div class="card">
                                    <div class="card-header text-bg-danger p-2 py-1">
                                        <h6> ব্যবসায় নিবন্ধন সংক্রান্ত তথ্য   </h6>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-4">
                                    <div class="card">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5 class="text-center mt-2"><b>২১৫</b></h5>
                                            </div>
                                            <div class="col-md-12">
                                                <h5 class="text-center">মোট ব্যবসায় প্রতিষ্ঠান</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
