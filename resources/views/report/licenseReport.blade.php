                    ...
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-5">
                                <div class="card">
                                    <div class="card-header text-bg-danger p-2 py-1">
                                        <h6> ট্রেড লাইসেন্স সংক্রান্ত তথ্য   </h6>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center">  মোট ট্রেড লাইসেন্স   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> পেন্ডিং ট্রেড লাইসেন্স   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট লাইসেন্স ফি  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট ভ্যাটের পরিমান  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট মূলধন কর  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 mt-5">
                                <div class="card">
                                    <div class="card-header text-bg-danger p-2 py-1">
                                        <h6>নবায়নকৃৃত  ট্রেড লাইসেন্স সংক্রান্ত তথ্য    </h6>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center">  মোট নবায়নকৃৃত ট্রেড লাইসেন্স   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center">  পেন্ডিং নবায়নকৃৃত  ট্রেড লাইসেন্স   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
