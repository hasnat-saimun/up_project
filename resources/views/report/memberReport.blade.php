                                ...
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট হোল্ডিং   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট পুরুষ সদস্য  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center">মোট মহিলা সদ্স্য  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট জনসংখ্যা </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> পুরুষ জনসংখ্যা </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মহিলা জনসংখ্যা  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> কাচাঁ ঘর  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> আধা পাকা ঘর  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> পাকা ঘর  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> বহুতল ঘর  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> ইসলাম ধর্মালম্বী </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> হিন্দু ধর্মালম্বী </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center">  খ্রিষ্টান ধর্মালম্বী  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3 mt-3">
                                    <div class="card">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <h5 class="text-center"> অন্যান্য ধর্মালম্বী  </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
