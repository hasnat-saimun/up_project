                            ...
                            <div class="row mt-3">
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5 class="text-center mt-2"><b>৫৮</b></h5>
                                            </div>
                                            <div class="col-md-12">
                                                <h5 class="text-center"> মোট ওয়ারিশ </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="card">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5 class="text-center mt-2"><b>৬</b></h5>
                                            </div>
                                            <div class="col-md-12">
                                                <h5 class="text-center"> পেন্ডিং ওয়ারিশ   </h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
