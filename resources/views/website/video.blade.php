                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class=" card-box p-2 ">
                                        <div class="mb-3">
                                            <label for="name">ভিডিও নাম</label>
                                            <input type="text" class="form-control" id="name" placeholder="" name="name" />
                                        </div>
                                        <div class="mb-3">
                                            <label for="video"> ভিডিও </label>
                                            <input type="file" name="video" id="video" class="form-control" accept=".jpg, .jpeg, .png, .gif, .webp" oninput="pic.src=window.URL.createObjectURL(this.files[0])">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-md-12 mt-4">
                                    <table class="table table-hover table-border border-primary">
                                        <thead>
                                            <tr>
                                                <th scope="col">#</th>
                                                <th scope="col">ভিডিও</th>
                                                <th scope="col"> ভিডিও নাম </th>
