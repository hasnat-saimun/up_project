                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class=" card-box p-2 ">
                                        ...
                                        <div class="mb-3">
                                            <label for="busType" class="form-label">আয়ের  ধরন</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="incomeFund">আয়ের খাত </label>
                                            <input type="text" class="form-control" id="incomeFund" placeholder="" name="incomeFund" />
                                        </div>
                                        <div class="mb-3">
